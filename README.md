...
<p><strong>本次重点：</strong> v2.0.1 Beta 延续 Windows 2.0 桌面交付线，并同步 Mac 端最新奇门遁甲修复：拆补/置润起局、精确交节换节、真太阳时四柱、天盘干、门神星与本地历法回退都按 Horosa 手机版算法重新。</p>
...
<table>
  ...
  <tr>
    ...
    <td width="50%">
      ...
      - 中国传统与术数工作流覆盖八字、紫微、易、六壬、遁甲、太乙、三式合一、风水、万年历与相关面板<br />
      ...
      - 奇门遁甲同步最新 Mac / 手机版路径，拆补与置润均覆盖精确交节分钟、真太阳时四柱、天盘干、门、神、星与本地历法回退数据<br />
...
- Bazi, Ziwei, calendar, Feng Shui, gua-symbol references, twelve-palace tools, and rule references / 八字、紫微、万年历、风水、八卦类象、十二串宫与规则
...
- Sanshi workspace with overview, Tai Yi, shensha, Liu Ren, major patterns, sub-patterns, references, Bagong details, and exportable snapshots / 三式工作区包含概览、太乙、神煞、六壬、大格、小局、、八宫详情与可导出快照
